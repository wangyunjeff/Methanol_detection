...
writer1 = SummaryWriter('runs_IN_difTest/MLP100-triplet1-withexposure')
...
# 加载数据集
train_dataset = load_triplet_dataset('./IN_train_data_with_labels_difTest.csv', focus_labels, focus_factors)
test_dataset = load_triplet_dataset('./IN_test_data_with_labels_difTest.csv', focus_labels, focus_factors)
